...
- Hashtags should be 8–15 tags, simple, mostly lowercase, no weird punctuation.
- Do NOT include backticks or the word "JSON" in the output, only the raw JSON object.

For each field:
- facebook: 1–3 short paragraphs, punchy hook, then bullet-style benefits.
- instagram: similar to facebook, slightly more vibe, include 3–5 short benefit lines.
- tiktok: short, high-energy, feels like a voiceover or caption for a vertical video.
...
- marketplace: great for Facebook Marketplace description (no emojis at the top).
...
- No cringe, no fake hype, but still strong CTA
        ...
        <div class="stack-vertical">
          <div class="section-title-row">
            <div>
              ...
              <div class="card-subtitle">Grab dealer photos and turn them into a simple video plan.</div>
            </div>
          </div>

          <div class="pill-row">
            <button id="grabPhotosButton" class="button-ghost" type="button">
              <span class="icon">📸</span><span>Grab Photos From URL</span>
            </button>
