document.addEventListener("DOMContentLoaded", () => {
  ...
  function showPanel(key) {
    ...
    const panelToShow = panels[key];
    if (panelToShow) panelToShow.classList.add("is-active");
  }

  // Attach launcher click events
  ...
  if (objectionForm && objectionOutput) {
    objectionForm.addEventListener("submit", (e) => {
      ...
      const name = document.getElementById("objectionCustomer").value.trim();
      ...
      let opener = `I totally understand where you're coming from, and I appreciate you being honest with me.`;
      let body = "";
      let close =
        `The last thing I want is for ${person} to feel pressured. ` +
  ...
  if (messageForm && messageOutput) {
    messageForm.addEventListener("submit", (e) => {
      ...
      const name = document.getElementById("msgCustomer").value.trim() || "there";
