...
/**
 * Adds an image URL to the social-ready strip.
 * - If already exists: selects it and updates preview
 * - If new: pushes it, caps the list, selects newest, updates preview
 */
