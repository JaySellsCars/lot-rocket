...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (creativeOverlay && openCreativeStudioBtn) {
    // Safety check – make sure Fabric.js is loaded
    if (typeof fabric === "undefined") {
      ...
      if (deleteBtn) deleteBtn.addEventListener("click", deleteActiveObject);
      ...
      document.addEventListener("keydown", (e) => {
        if (
          e.key === "Escape" &&
          !creativeOverlay.classList.contains("hidden")
        ) {
          closeCreativeStudio();
        }
      });
    } // end fabric-loaded else
  } // end Creative Studio wrapper
